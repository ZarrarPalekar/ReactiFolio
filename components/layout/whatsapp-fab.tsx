...
export function WhatsAppFab() {
  return (
    <Link
      ...
      className="fixed bottom-5 right-5 z-[70] inline-flex h-15 w-15 items-center justify-center rounded-full border border-red-500/35 bg-red-600 text-white shadow-[0_0_0_10px_rgba(239,68,68,0.1),0_0_32px_rgba(239,68,68,0.28)] transition hover:scale-[1.03] hover:bg-red-500 sm:bottom-6 sm:right-6"
      style={{
