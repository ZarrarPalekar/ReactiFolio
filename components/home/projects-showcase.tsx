  ...
  return (
    <section id="projects" className="border-b border-white/10 py-20 sm:py-28">
      <Container>
        <SectionHeading
          eyebrow="Projects"
          title="Selected work with strong product thinking and practical engineering."
          description="A curated set of builds that show range across commerce, social products, productivity tools, and personal branding."
        />
            ...
            >
              ...
              <div className="flex flex-col justify-between p-6 sm:p-8 lg:p-10">
                <div>
                  ...
                  <p className="mt-4 text-base leading-7 text-white/54">{project.description}</p>
                </div>
